 ...
 * @author servi
 */
public class ReservaAdministrador extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btnvolver.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Archivos/002-flecha-1.png"))); // NOI18N
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(labeltipos1, javax.swing.GroupLayout.DEFAULT_SIZE, 27, Short.MAX_VALUE)
                    .addComponent(labeltipos2, javax.swing.GroupLayout.DEFAULT_SIZE, 27, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnsiguientehabActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsiguientehabActionPerformed
        ...
        escritorio.repaint();
        ResgitroReservaAdmin log = new ResgitroReservaAdmin(id_reserva, adultos, niños, nro_hab_elegida, precio_noche);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReservaAdministrador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReservaAdministrador().setVisible(true);
            }
        });
    }
