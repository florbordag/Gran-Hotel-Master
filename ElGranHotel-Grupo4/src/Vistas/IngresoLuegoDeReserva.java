...
public class IngresoLuegoDeReserva extends javax.swing.JInternalFrame {
    ...
    private void btningresoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btningresoActionPerformed
        ...
        if (txtloginapellido.getText().equals("")) {
            ...
            if (verificarHuesped()) {
                ...
                SesionReservaHuesped sh = new SesionReservaHuesped(this.id_reserva, this.id_huesped, adultos, niños, numhab, precio_noche);
    ...
    private void btnregresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnregresarActionPerformed
        //Aqui debo regresar a la ventana de login/registro.
        escritorio.removeAll();
        escritorio.repaint();
