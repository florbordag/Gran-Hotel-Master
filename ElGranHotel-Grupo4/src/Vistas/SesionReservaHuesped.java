...
public class SesionReservaHuesped extends javax.swing.JInternalFrame {
    ...
    public SesionReservaHuesped(int id_reserva, int id_huesped, int adultos, int niños, int numhab, double precio_noche) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SesionReservaHuesped.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SesionReservaHuesped().setVisible(true);
            }
        });
    }
